...
class MainView(View):
    def get(self, request):
        return render(request, 'tours/index.html', {'tours': sample(tours.items(), 6),
                                                    'title': title,
                                                    'subtitle': subtitle,
...
class Departure_view(View):
    def get(self, request, departure):
        ...
        try:
            ...
            raise Http404
        return render(request, 'tours/departure.html', {'departures': departures.items(),
                                                        'departure': departure,
...
class TourView(View):
    def get(self, request, id):
        ...
        return render(request, 'tours/tour.html', {'departures': departures.items(), 'tour': tour, 'dep': dep})
